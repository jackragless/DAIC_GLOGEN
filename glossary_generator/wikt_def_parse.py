# wikt_def_parse module sends requests HTML for given term from wiktionary
# and converts into custom array format
...
# codebase from https://github.com/Suyash458/WiktionaryParser
# modified for improved example extraction
...
# refomats wiktionary object for use in GLOGEN
...
#driver function; takes term to define; handless errors; returns wiktionary object
def define(kw):
